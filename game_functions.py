...
def update_bullets(ai_settings, screen, stats, sb, ship, alien, bullets):
	...
	check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, alien, bullets)
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, alien, bullets):
